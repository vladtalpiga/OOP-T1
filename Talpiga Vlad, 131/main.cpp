...
// Setters and getters
    ...
    void setMediaGenerala(double media_generala){
        this-> media_generala = media_generala;
    }
...
// Verificare daca exista student dupa nume
    ...
    int meniu(){
        ...
        cout<<"3. Verificati daca un student este in grupa. Daca numele acestuia exista in grupa, se vor afisa informatiile sale."<<endl;
        ...
        case 1:
            {
                ...
                cout<<endl<<"Studentul "<<A.getNume()<<" a fost adaugat in grupa."<<endl<<endl;
        ...
        case 2:
            {
                ...
                if (G1.existaStudent(name) == 0){

                    cout<<endl<<"Acest student nu poate fi eliminat, deoarece nu se afla in grupa."<<endl<<endl;

                } else {

                G1.stergeStudent(name);

                cout<<endl<<"Studentul "<<name<<" a fost eliminat din grupa."<<endl<<endl;
